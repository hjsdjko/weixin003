...
public class WupinxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：几成新
	 */
	public void setJichengxin(String jichengxin) {
		this.jichengxin = jichengxin;
	}
	/**
	 * 获取：几成新
	 */
	 ...
	 * 设置：物品来源
	 */
	public void setWupinlaiyuan(String wupinlaiyuan) {
		this.wupinlaiyuan = wupinlaiyuan;
	}
	/**
	 * 获取：物品来源
	 */
	public String getWupinlaiyuan() {
		return wupinlaiyuan;
	}
	/**
	 * 设置：物品详情
