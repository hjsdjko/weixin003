...
<script>
	export default {
		...
		async onShow(options) {
			...
			let cleanType = uni.getStorageSync('discussdiscusswupinxinxiCleanType')
			if(cleanType){
				uni.removeStorageSync('discussdiscusswupinxinxiCleanType')
				this.mescroll.num = 1
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('discusswupinxinxi', this.id);
